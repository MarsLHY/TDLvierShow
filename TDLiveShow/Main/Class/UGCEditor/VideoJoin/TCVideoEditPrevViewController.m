...
@interface TCVideoEditPrevViewController ()<TXVideoGenerateListener,TXVideoJoinerListener,TCVideoPreviewDelegate>
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    _videoPreview = [[TCVideoPreview alloc] initWithFrame:CGRectMake(0, 0, self.prevPlaceHolder.width, self.prevPlaceHolder.height) coverImage:[TXVideoInfoReader getVideoInfo:_composeArray.firstObject].coverImage];
